...
from models.crowdhuman.builder import FPNRpnHeadwithIgnore as RpnHead
...
def get_config(is_train):
    ...
    class OptimizeParam:
        ...
        class schedule:
            begin_epoch = 0
            # end_epoch = 15
            # lr_iter = [18750 * 16 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image),
            #            24375 * 16 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image)]
            end_epoch = 10
